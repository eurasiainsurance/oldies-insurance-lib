...
public class PersonalInfo {
    ...
    public PersonalInfo(String firstName, String lastName, String middleName, Calendar dayOfBirth, SexInfo sex) {
    ...
    public SexInfo getSex() {
	return sex;
    }

    public void setSex(SexInfo sex) {
	this.sex = sex;
    }
