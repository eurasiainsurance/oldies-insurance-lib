...
CREATE TABLE REQUEST (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), ACCEPTED DATETIME, CLOSED DATETIME, COMPLETED DATETIME, CREATED DATETIME, NOTE VARCHAR(255), PROGRESS_STATUS VARCHAR(255), SOURCE VARCHAR(255), STATUS VARCHAR(255), UPDATED DATETIME, REQUESTER_ALLOW_PROCESS_PERSONAL_DATA TINYINT(1) default 0, REQUESTER_ALLOW_SPAM TINYINT(1) default 0, REQUESTER_EMAIL VARCHAR(255), REQUESTER_ID_NUMBER VARCHAR(255), REQUESTER_NAME VARCHAR(255), REQUESTER_PREFER_LANGUAGE VARCHAR(255), REQUESTER_PHONE_AREA_CODE VARCHAR(255), REQUESTER_PHONE_COUNTRY_CODE VARCHAR(255), REQUESTER_PHONE_NUMBER VARCHAR(255), UTM_CAMPAIGN VARCHAR(255), UTM_CONTENT VARCHAR(255), UTM_MEDIUM VARCHAR(255), UTM_SOURCE VARCHAR(255), UTM_TERM VARCHAR(255), ACCEPTED_BY_USER_ID INTEGER, CLOSED_BY_USER_ID INTEGER, COMPLETED_BY_USER_ID INTEGER, CREATED_BY_USER_ID INTEGER, PRIMARY KEY (ID))
