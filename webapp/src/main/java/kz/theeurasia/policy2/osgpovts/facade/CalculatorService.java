...
public class CalculatorService {
    ...
    // private void _prepareInsured(List<Insured> insuredList) throws
    // ESBDException, ESBDFaultException {
    // for (Insured insured : insuredList) {
    // try {
    ...
    // ClientInfo clientInfo = esbdAccessService.getClientInfo(new
    // IdNumber(insured.getIdNumber()));
    ...
    public double calculate(List<Insured> insuredList, List<Vehicle> vehicleList, PolicyTermClass policyTermClass)
