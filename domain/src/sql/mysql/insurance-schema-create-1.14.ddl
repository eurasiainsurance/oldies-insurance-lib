CREATE TABLE IMAGE (ID INTEGER AUTO_INCREMENT NOT NULL, CONTENT LONGBLOB, FILE_NAME VARCHAR(255), MIME_TYPE VARCHAR(255), PRIMARY KEY (ID))
CREATE TABLE IDENTITY_CARD (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, ISSUING_AUTHORITY VARCHAR(255), NUMBER VARCHAR(255), TYPE VARCHAR(255), BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE VEHICLE_CERTIFICATE (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, VEHICLE_CERTITFICATE_NUMBER VARCHAR(255), VEHICLE_REGISTRATION_NUMBER VARCHAR(255), BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER (ID INTEGER AUTO_INCREMENT NOT NULL, EMAIL VARCHAR(255), HIDDEN TINYINT(1) default 0, NAME VARCHAR(255), PRIMARY KEY (ID))
...
CREATE TABLE DRIVER_LICENSE (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, NUMBER VARCHAR(255), BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE CASCO_VEHICLE (ID INTEGER NOT NULL, VEHICLE_CAR_AGE_CLASS VARCHAR(255), VEHICLE_COST DOUBLE, VIEW1_IMAGE_ID INTEGER, VIEW2_IMAGE_ID INTEGER, VIEW3_IMAGE_ID INTEGER, VIEW4_IMAGE_ID INTEGER, PRIMARY KEY (ID))
